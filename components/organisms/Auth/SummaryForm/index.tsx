...
import { RiUser3Line, RiUploadCloud2Line } from "react-icons/ri";
import { ModalRegisterCompany } from '@/components/molecules';
        ...
        <div className="flex justify-center items-center p-4 lg:py-[70px] bg-gray-300 rounded-md lg:rounded-df">
          <div className="bg-white rounded-md lg:rounded-df lg:w-[580px] p-8">
            ...
            <div className="relative flex justify-start items-center">
              <div className="flex justify-center items-center w-[82px] h-[82px] rounded-full bg-gray-300 border border-gray-150">
                <RiUser3Line className="text-2xl text-gray-500" />
              </div>
              <Buttons control="secondary" type="button" text={<TextUpload />} className="h-9 px-3 ml-3 shadow-sm" />
            </div>

            <div className="w-full pt-6 pb-4">
              <p className="uppercase text-xs font-semibold text-black-100 opacity-40">
                Personal Info
              </p>
            </div>
            ...
            <div className="w-full pt-6 pb-4 border-t border-gray-150">
              <p className="uppercase text-xs font-semibold text-black-100 opacity-40">
                Company Detail
              </p>
            </div>
...
const TextUpload = () => {
  return (
    <div className="flex justify-center items-center">
      <RiUploadCloud2Line className="text-blue-500 text-xl mr-2" /> Upload
    </div>
  )
}