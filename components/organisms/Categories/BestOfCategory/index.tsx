...
import { DropdownBestCategory, Headings } from '@/components/atoms';
import {
    RiBookOpenLine,
    RiNewspaperLine,
    RiCamera3Line,
...
const BestOfCategory = () => {
    ...
    return (
        <section className="bg-white px-3 lg:px-16 pt-5 lg:pt-14 lg:pb-12">
            <div className="container max-w-container mx-auto px-2 lg:px-0">
                <div className="mb-4 lg:mb-[50px]">
                    <Headings control="h1" text="Explore best of categories" />
                </div>
